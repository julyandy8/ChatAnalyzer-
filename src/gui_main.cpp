                         ...
                         WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_CREATE:
    {
        ...
        SendMessageW(g_hEdit, EM_SETBKGNDCOLOR, 0, (LPARAM)RGB(26, 26, 34));
        ...
        // Intro text
        {
            std::string intro =
                ...
                "How to Use\n"
                "--------------------------------------------------------------\n"
                "0) IMPORTANT: Keep these files next to ChatAnalyzer.exe:\n"
                "   - vader_lexicon.txt\n"
                "   - nrc_emotion_lexicon.txt\n"
                "   If they're missing, sentiment/emotion analysis won't work.\n\n"

                "1) Pick your platform:\n"
                "   Instagram:\n"
                "   - Request your data archive from Meta (Messages included).\n"
                "   - Select the folder that contains message_1.json, message_2.json, etc.\n\n"

                "   Discord:\n"
                "   - Export using Discrub (Chrome extension) as JSON.\n"
                "   - Click 'Discord File Convert' and select the Discrub export folder.\n"
                "   - The app creates a 'discord_converted' folder.\n\n"

                "   WhatsApp:\n"
                "   - In the chat: Export Chat -> WITHOUT media (recommended).\n"
                "   - Click 'WhatsApp File Convert' and select the exported _chat.txt.\n"
                "   - The app creates a 'whatsapp_converted' folder.\n\n"

                "   Android SMS:\n"
                "   - Use 'SMS Backup & Restore' from the app store to create an XML backup.\n"
                "   - Click 'Android SMS Convert' and select the XML.\n"
                "   - Wait. It's going to load. Pick a contact from the list.\n"
                "   - The app creates an 'android_sms_converted' folder.\n\n"

                "   iMessage:\n"
                "   - Requires an iOS backup folder that contains Manifest.db. You can get the backup through Itunes backing up to your computer or other methods.\n"
                "   - Click 'iMessage File Convert' and select the backup folder.\n"
                "   - Choose a chat when prompted.\n"
                "   - The app creates an 'imessage_converted' folder.\n\n"

                "2) Run Analysis\n"
                "--------------------------------------------------------------\n"
                "- Click 'Select File' (single JSON) or 'Select Folder' (multiple JSON chunks).\n"
                "- If you used a Convert button, the app already selects the converted folder for you.\n"
                "- Click 'Run Analysis'. Large exports can take a while.\n\n"

                "Privacy\n"
                "--------------------------------------------------------------\n"
                "- This tool runs locally. It does not upload your chats anywhere. I wouldn't even know how to do that. And honestly..don't care or want too.\n"
                "- Do not share exported chat logs publicly.\n\n"

                "Some Facts & Stuff:\n"
                "--------------------------------------------------------------\n"
                "- I don't know if the apple format works as I didn't have any backups to test it on. I bet the lexicon code is a little off - Shoulda done python. \n"
                "- Instagram takes about 6 hrs~ to get the data back from Meta & Discord takes about 20~ minutes using the browser extension. Meanwhile, the official export for discord takes daays to recieve(which it's not tested on). \n\n\n\n"
                ...
                "- Feel free to send any Code Issues on Github or more Ideas for useful analytics to track.\n"
                "- Anything else at: GithubAccountNameFirstWord|is|GithubAccountNameSecondWord|GithubAccountEndingNumber at g|m|a|i|l|.com\n";
